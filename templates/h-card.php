<div class="hcard-display h-card vcard u-author">
	<div class="hcard-header">
		...
		<?php } else { ?>
			<a class="u-url url fn u-uid" href="<?php echo esc_url( $url ); ?>"><?php echo $avatar; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Avatar is generated by get_avatar() ?></a>
				<p class="hcard-name p-name n"><?php echo esc_html( $name ); ?></p>
		<?php }
		if ( $args['email'] ) { ?>
			<p>
