...
class IndieWeb_General_Settings {
 ...
 public static function admin_menu() {
     ...
     add_submenu_page( 
        'indieweb',
        __( 'General Options', 'indieweb' ), // page title
        __( 'General Options', 'indieweb' ), // menu title
    ...
    add_settings_section(
        ...
        array( 'IndieWeb_General_Settings', 'general_options_callback'), // Callback used to render the description of the section
    ...
    add_settings_field(
      ...
      array(                              // The array of arguments to pass to the callback. In this case, just a description.
        'name' => 'iw_single_author',
				'description' => 'If this website represents a single individual, select this setting.'
      )
     );
  ...
  public static function general_options_callback() {
    echo '<p>';
    esc_html_e( 'Provides support for rel-me links, either through a widget or invisibly adding them to the page.', 'indieweb' );
    echo '</p>';
  }
  ...
  public static function general_options_page() {
    ...
    settings_fields( 'iw_general_settings' );
