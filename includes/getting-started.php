<div class="wrap indieweb-getting-started">
	...
	<div class="indieweb-flex-container">
		...
		<div class="indieweb-flex what-is">
			...
			<p><?php echo wp_kses( __( '<strong>Own your data.</strong> Create and publish content on your own site, and only optionally syndicate to third-party silos.', 'indieweb' ), array( 'strong' => array() ) ); ?></p>
			<p>
				<?php
				echo wp_kses(
			...
			<p><?php echo wp_kses( __( 'For even more information, please visit the <a href="https://indieweb.org/" target="_blank"><em>IndieWeb</em> wiki</a>.', 'indieweb' ), array( 'a' => array( 'href' => array(), 'target' => array() ), 'em' => array() ) ); ?></p>
			<p><?php echo wp_kses( __( 'For assistance and to chat with community members, please visit <a href="https://indieweb.org/discuss" target="_blank">the discuss</a> page for more details.', 'indieweb' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ); ?></p>
		</div>

		<div class="indieweb-flex indieweb-plugins">
			<h2><?php esc_html_e( 'Plugins', 'indieweb' ); ?></h2>

			<p><?php echo wp_kses( __( 'After you have established your identity, you can now optionally log into the <a href="https://indieweb.org">IndieWeb wiki</a> and create a user page as a way of introducing yourself to the community. The wiki is also a great source of IndieWeb information', 'indieweb' ), array( 'a' => array( 'href' => array() ) ) ); ?></p>
		...
		<div class="indieweb-flex indieweb-themes">
			...
			<p><?php echo wp_kses( __( 'The IndieWeb uses <a href="https://indieweb.org/microformats">microformats2</a> to mark up sites so that they can be interpreted by other sites when retrieved.', 'indieweb' ), array( 'a' => array( 'href' => array() ) ) ); ?></p>
